...
import (
	...
	mocks "github.com/ODUWAX/rosetta-oduwacoin/mocks/services"
...
func TestConstructionService(t *testing.T) {
	...
	cfg := &configuration.Configuration{
		...
		Params:   oduwacoin.TestnetParams,
		Currency: oduwacoin.TestnetCurrency,
	}
	...
	metadata := &constructionMetadata{
		ScriptPubKeys: []*oduwacoin.ScriptPubKey{
			{
	...
	// Test Submit
	oduwacoinTransaction := "" // nolint
	mockClient.On(
		"SendRawTransaction",
		ctx,
		oduwacoinTransaction,
	).Return(
