...
const (
	...
	// of rosetta-oduwacoin. We set this as a
...
type unsignedTransaction struct {
	...
	ScriptPubKeys  []*oduwacoin.ScriptPubKey `json:"scriptPubKeys"`
...
type constructionMetadata struct {
	ScriptPubKeys []*oduwacoin.ScriptPubKey `json:"script_pub_keys"`
}
...
type ParseOperationMetadata struct {
	ScriptPubKey *oduwacoin.ScriptPubKey `json:"scriptPubKey"`
}
