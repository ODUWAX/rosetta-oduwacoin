...
import (
	...
	mocks "github.com/ODUWAX/rosetta-oduwacoin/mocks/indexer"
...
func TestIndexer_Pruning(t *testing.T) {
	...
	cfg := &configuration.Configuration{
		...
		GenesisBlockIdentifier: oduwacoin.MainnetGenesisBlockIdentifier,
...
func TestIndexer_Transactions(t *testing.T) {
	...
	for i := int64(0); i <= 1000; i++ {
		...
		for j := 0; j < 5; j++ {
			...
			scriptPubKey := &oduwacoin.ScriptPubKey{
				ASM: coinIdentifier,
			}
				...
				Operations: []*types.Operation{
					{
						...
						Status: types.String(oduwacoin.SuccessStatus),
	...
	go func() {
		for {
			...
			if currBlock.BlockIdentifier.Index == 1000 {
				...
				allCoins := []*types.Coin{}
				expectedPubKeys := []*oduwacoin.ScriptPubKey{}
