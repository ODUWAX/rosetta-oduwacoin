...
const (
	// Blockchain is Oduwacoin.
	Blockchain string = "Oduwacoin"
	...
	// SatoshisInOduwacoin is the number of
	// Satoshis in 1 BTC (10^8).
	SatoshisInOduwacoin = 100000000
	...
	// Oduwacoin operations because anything
	...
	// of any transaction hash in Oduwacoin.
	TransactionHashLength = 64

	// NullData is returned by oduwacoind
...
// Source: https://oduwacoinops.org/en/tools/calc-size/
const (
...
var (
	...
	MainnetGenesisBlockIdentifier = &types.BlockIdentifier{
		Hash: "000006301df0e22e8c3b5eed7aa53e9d3194652b4c7871390f265b0506c9583e",
	}
...
// of a Oduwacoin transaction that must be satisfied to spend
// the output.
...
// Oduwacoin transaction that satisfies the ScriptPubKey
...
// BlockchainInfo is information about the Oduwacoin network.
...
// Block is a raw Oduwacoin block (with verbosity == 2).
type Block struct {
...
// Transaction is a raw Oduwacoin transaction.
...
// Input is a raw input in a Oduwacoin transaction.
type Input struct {
...
// Output is a raw output in a Oduwacoin transaction.
type Output struct {
...
// metadata from Oduwacoin inputs and outputs.
