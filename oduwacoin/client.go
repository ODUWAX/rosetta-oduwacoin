...
import (
	...
	oduwacoinUtils "github.com/ODUWAX/rosetta-oduwacoin/utils"
...
const (
	...
	// genesis block of the oduwacoin blockchain for polling
	genesisBlockIndex = 0
...
const (
	// https://oduwacoin.org/en/developer-reference#getblock
	requestMethodGetBlock requestMethod = "getblock"

	// https://oduwacoin.org/en/developer-reference#getblockhash
	requestMethodGetBlockHash requestMethod = "getblockhash"

	// https://oduwacoin.org/en/developer-reference#getblockchaininfo
	requestMethodGetBlockchainInfo requestMethod = "getblockchaininfo"

	// https://developer.oduwacoin.org/reference/rpc/getpeerinfo.html
	requestMethodGetPeerInfo requestMethod = "getpeerinfo"

	// https://developer.oduwacoin.org/reference/rpc/pruneblockchain.html
	requestMethodPruneBlockchain requestMethod = "pruneblockchain"

	// https://developer.oduwacoin.org/reference/rpc/sendrawtransaction.html
	requestMethodSendRawTransaction requestMethod = "sendrawtransaction"

	// https://developer.oduwacoin.org/reference/rpc/estimatesmartfee.html
	requestMethodEstimateSmartFee requestMethod = "estimatesmartfee"

	// https://developer.oduwacoin.org/reference/rpc/getrawmempool.html
...
const (
	...
	// returned in Oduwacoin blocks to be milliseconds.
	timeMultiplier = 1000

	// rpc credentials are fixed in rosetta-oduwacoin
	// because we never expose access to the raw oduwacoind
...
// Client is used to fetch blocks from oduwacoind and
// to parse Oduwacoin block data into Rosetta types.
//
// We opted not to use existing Oduwacoin RPC libraries
...
// NewClient creates a new Oduwacoin client.
func NewClient(
	baseURL string,
	genesisBlockIdentifier *types.BlockIdentifier,
	currency *types.Currency,
...
// ParseBlock returns a parsed oduwacoin block given a raw oduwacoin
...
// https://oduwacoincore.org/en/doc/0.20.0/rpc/blockchain/pruneblockchain
func (b *Client) PruneBlockchain(
	...
	// Parameters:
	//   1. Height
	// https://developer.oduwacoin.org/reference/rpc/pruneblockchain.html#argument-1-height
...
// function mirrors the behavior of a similar commit in oduwacoin-core.
//
// Source: https://github.com/oduwacoin/oduwacoin/commit/ab91bf39b7c11e9c86bb2043c24f0f377f1cf514
...
func (b *Client) parseTransactions(
	...
	logger := oduwacoinUtils.ExtractLogger(ctx, "client")
...
func (b *Client) parseTxOperations(
	...
	for networkIndex, input := range tx.Inputs {
		if oduwacoinIsCoinbaseInput(input, txIndex, networkIndex) {
...
// `oduwacoinOutput` transaction output.
func (b *Client) parseOutputTransactionOperation(
	...
	// If we are unable to parse the output account (i.e. oduwacoind
...
func (b *Client) getInputTxHash(
	...
	if oduwacoinIsCoinbaseInput(input, txIndex, inputIndex) {
		return "", -1, false
	}
...
// oduwacoinIsCoinbaseInput returns whether the specified input is
...
func oduwacoinIsCoinbaseInput(input *Input, txIndex int, inputIndex int) bool {
...
// parseOutputAccount parses a oduwacoinScriptPubKey and returns an account
...
// post makes a HTTP request to a Oduwacoin node
func (b *Client) post(
	ctx context.Context,
